-- `dipdup schema wipe` cannot drop these tables (TimescaleDB blocks
...
TRUNCATE TABLE dodo_mav, dodo_mav_history_data, launchpad_purchase_event, orderbook_order_event CASCADE;
