...
from equiteez.types.kyc.tezos_parameters.set_blacklist import SetBlacklistParameter, SetBlacklistAction as addToBlacklist
...
async def set_blacklist(
    ...
    # Update record
    if type(set_blacklist_action) == addToBlacklist:
        ...
        for blacklist_address in blacklist_addresses:
            ...
            await user.save()
            await models.KycBlacklisted.filter(
                kyc     = kyc,
                user    = user
            ).delete()
