...
from equiteez.types.dodo_mav.tezos_parameters.withdraw_all_base_tokens import (
    WithdrawAllBaseTokensParameter,
)
...
async def withdraw_all_base_tokens(
    ctx: HandlerContext,
    withdraw_all_base_tokens: TezosTransaction[
        WithdrawAllBaseTokensParameter, DodoMavStorage
    ],
) -> None:
