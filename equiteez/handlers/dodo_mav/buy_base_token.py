...
from equiteez.types.base_token.tezos_parameters.transfer import TransferParameter as MaintainerFeeParameter
...
async def buy_base_token(
    ...
    timestamp                   = parser.parse(buy_base_token.data.timestamp)
