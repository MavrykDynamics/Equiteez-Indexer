...
from equiteez.types.dodo_mav.tezos_parameters.withdraw_all_quote_tokens import (
    WithdrawAllQuoteTokensParameter,
)
...
async def withdraw_all_quote_tokens(
    ctx: HandlerContext,
    withdraw_all_quote_tokens: TezosTransaction[
        WithdrawAllQuoteTokensParameter, DodoMavStorage
    ],
) -> None:
