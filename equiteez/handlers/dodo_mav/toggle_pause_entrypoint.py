...
from equiteez.types.dodo_mav.tezos_parameters.toggle_pause_entrypoint import (
...
async def toggle_pause_entrypoint(
    ...
    toggle_pause_entrypoint: TezosTransaction[
        TogglePauseEntrypointParameter, DodoMavStorage
    ],
) -> None:
    ...
    for entrypoint in pause_ledger:
        ...
        entrypoint_status, _ = await models.DodoMavEntrypointStatus.get_or_create(
            contract=dodo_mav, entrypoint=entrypoint
        )
