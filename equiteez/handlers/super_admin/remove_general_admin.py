...
from equiteez.types.super_admin.tezos_parameters.remove_general_admin import (
    RemoveGeneralAdminParameter,
)
...
async def remove_general_admin(
    ctx: HandlerContext,
    remove_general_admin: TezosTransaction[
        RemoveGeneralAdminParameter, SuperAdminStorage
    ],
) -> None:
