...
from equiteez.types.super_admin.tezos_parameters.set_token_kyc_address import SetTokenKycAddressParameter
...
async def set_token_kyc_address(
    ctx: HandlerContext,
    set_token_kyc_address: TezosTransaction[SetTokenKycAddressParameter, SuperAdminStorage],
) -> None:
