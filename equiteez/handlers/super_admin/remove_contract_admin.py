...
from equiteez.types.super_admin.tezos_parameters.remove_contract_admin import (
    RemoveContractAdminParameter,
)
...
async def remove_contract_admin(
    ctx: HandlerContext,
    remove_contract_admin: TezosTransaction[
        RemoveContractAdminParameter, SuperAdminStorage
    ],
) -> None:
