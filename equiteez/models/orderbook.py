...
class Orderbook(Model):
    ...
    rwa_token = fields.ForeignKeyField(
        "models.Token", related_name="orderbooks", null=True
    )
...
class OrderbookEntrypointStatus(Model, EntrypointStatus):
    ...
    contract = fields.ForeignKeyField(
        "models.Orderbook", related_name="entrypoint_status"
    )
...
class OrderbookFee(Model):
    ...
    related_token = fields.ForeignKeyField(
        "models.Token", related_name="orderbook_fees", null=True
    )
...
class OrderbookRwaOrderBuyPrice(Model):
    ...
    rwa_order = fields.ForeignKeyField(
        "models.OrderbookRwaOrder", related_name="orderbook_rwa_order_buy_prices"
    )
...
class OrderbookRwaOrderSellPrice(Model):
    ...
    # Reference to RWA order
    rwa_order = fields.ForeignKeyField(
        "models.OrderbookRwaOrder", related_name="orderbook_rwa_order_sell_prices"
    )
...
class OrderbookOrder(Model):
    ...
    initiator = fields.ForeignKeyField(
        "models.EquiteezUser", related_name="orderbook_orders"
    )
